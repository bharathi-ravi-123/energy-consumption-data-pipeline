...
The Silver layer is implemented using dbt models, allowing transformations to be modular, maintainable, and testable.
...
The Gold layer follows a Star Schema with dimension tables and fact tables.
...
Business values follow expected formats
...
This helps ensure that only reliable data reaches the analytics and dashboard layer.
...
The pipeline uses Slack notifications for monitoring pipeline execution.

Failure Notification

When a pipeline task fails, Airflow sends a Slack notification containing information about the failed task.

Success Notification

After successful pipeline execution, a completion notification is sent to Slack.

The monitoring process helps identify pipeline failures quickly and supports reliable production execution.

📊 Analytics Dashboards

The Gold layer provides analytics-ready data for dashboard reporting.

⚡ Energy Forecast Dashboard

View Energy Forecast Dashboard

⚡ Energy Grid Dashboard

View Energy Grid Dashboard

⚡ Energy Overview Dashboard

View Energy Overview Dashboard
...
This project is currently under development, with the core ingestion, transformation, data modelling, testing, orchestration, and dashboard components implemented progressively.
